          ...
          <div className="flex items-center justify-between py-4">
            ...
            <div className="flex items-center space-x-8">
              ...
              <div className="flex items-center space-x-3">
                <div className="w-10 h-10 bg-gradient-to-r from-[var(--brand-primary)] to-[var(--brand-secondary)] rounded-xl flex items-center justify-center shadow-lg">
              ...
              {teams && teams.length > 0 && (
                <div className="relative hidden md:block" ref={teamDropdownRef}>
                  ...
                  >
                    <Avatar
                      size="sm"
                      fallback={currentTeam?.name?.[0]?.toUpperCase() || 'T'}
                    />
            ...
            <div className="flex-1 max-w-md mx-8 hidden md:block" ref={searchRef}>
              <div className={`relative transition-all duration-300 ${searchExpanded ? 'w-full' : 'w-12'}`}>
                ...
                <input
                  type="text"
                  placeholder="Search teams, channels, messages... (⌘K)"
                  value={searchQuery}
                ...
                {searchExpanded && (
                  <div className="absolute right-3 top-1/2 transform -translate-y-1/2 flex items-center space-x-1">
                    <kbd className="px-2 py-1 text-xs bg-[var(--tertiary-bg)] border border-[var(--border-color)] rounded">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="relative" ref={notificationsRef}>
                ...
                >
                  ...
                  {unreadCount > 0 && (
                    <span className="absolute -top-1 -right-1 w-5 h-5 bg-[var(--error)] text-white text-xs rounded-full flex items-center justify-center animate-pulse">
                      {unreadCount}
                    </span>
                  )}
                </button>
                ...
                {notificationsOpen && (
                  <div className="absolute right-0 top-12 dropdown-menu w-80 fade-in">
                      ...
                      {notifications.map((notification) => (
                        <div
                          ...
                          className={`px-4 py-3 hover:bg-[var(--tertiary-bg)] transition-colors duration-200 cursor-pointer ${
                            notification.unread ? 'border-l-2 border-[var(--brand-primary)]' : ''
                          }`}
                        >
                          <div className="flex items-start space-x-3">
                            <div className={`w-2 h-2 rounded-full mt-2 ${notification.unread ? 'bg-[var(--brand-primary)]' : 'bg-[var(--text-subtle)]'}`}></div>
                    ...
                    <div className="px-4 py-3 border-t border-[var(--border-color)]">
                      <button className="text-sm text-[var(--brand-primary)] hover:text-[var(--brand-primary-hover)] transition-colors duration-200">
                  ...
                  <div className="absolute right-0 top-12 dropdown-menu fade-in">
                    ...
                    <div className="border-t border-[var(--border-color)] pt-2">
                      <button
                        ...
                        className="dropdown-item w-full text-[var(--error)] hover:text-[var(--error-light)]"
                      >
